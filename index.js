...
var $author$project$Bubblesort$analytics = _Platform_outgoingPort('analytics', $elm$core$Basics$identity);
...
var $author$project$Bubblesort$DecrementBAndResetI = {$: 'DecrementBAndResetI'};
var $author$project$Bubblesort$Increment = {$: 'Increment'};
var $author$project$Bubblesort$SwapAndIncrement = {$: 'SwapAndIncrement'};
...
var $author$project$Bubblesort$btns = _List_fromArray(
	[
		A2($author$project$DrivingTest$primaryButton, 'Increment I', $author$project$Bubblesort$Increment),
		A2($author$project$DrivingTest$primaryButton, 'Swap and Increment I', $author$project$Bubblesort$SwapAndIncrement),
		A2($author$project$DrivingTest$primaryButton, 'Decrement And Reset', $author$project$Bubblesort$DecrementBAndResetI)
	]);
var $author$project$Bubblesort$GotRandom = function (a) {
	return {$: 'GotRandom', a: a};
};
var $author$project$Bubblesort$Model = F3(
...
var $author$project$Bubblesort$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			...
			_Utils_Tuple0,
			A3(
				$author$project$Bubblesort$Model,
				_List_fromArray(
					[5, 4, 3, 2, 1]),
				0,
				5)),
		A2(
			$elm$random$Random$generate,
			$author$project$Bubblesort$GotRandom,
			A2(
...
var $author$project$Bubblesort$ordered = F3(
	function (i, j, nums) {
...
var $author$project$Bubblesort$isEnabled = F2(
	function (msg, state) {
		var _v0 = state.ts;
		var i = _v0.i;
		var b = _v0.b;
		...
		switch (msg.$) {
			case 'Increment':
				var incrementable = _Utils_cmp(i, b - 1) < 0;
				return (incrementable && _Utils_eq(
					A3($author$project$Bubblesort$ordered, i, i + 1, numbers),
					$elm$core$Basics$LT)) ? $elm$core$Result$Ok('Incremented i') : $elm$core$Result$Err('Cannot increment i');
			case 'SwapAndIncrement':
				var incrementable = _Utils_cmp(i, b - 1) < 0;
				return (incrementable && _Utils_eq(
					A3($author$project$Bubblesort$ordered, i, i + 1, numbers),
					$elm$core$Basics$GT)) ? $elm$core$Result$Ok('Swapped i and i+1, Incremented i') : $elm$core$Result$Err('Cannot swap and increment i');
			case 'DecrementBAndResetI':
				var resetable = _Utils_eq(i, b - 1) && (i > 0);
				return resetable ? $elm$core$Result$Ok('Decremented B and resetted i') : $elm$core$Result$Err('Cannot decrement b and reset i');
			default:
...
var $author$project$Bubblesort$msgType = function (msg) {
	if (msg.$ === 'GotRandom') {
...
var $author$project$Bubblesort$next = function (state) {
	var _v0 = state.ts;
	var i = _v0.i;
	var b = _v0.b;
	var numbers = _v0.numbers;
	if ((!i) && (b === 1)) {
		...
		if (_Utils_cmp(i, b - 1) < 0) {
			var _v1 = A3($author$project$Bubblesort$ordered, i, i + 1, numbers);
			switch (_v1.$) {
				case 'LT':
					return _List_fromArray(
						[$author$project$Bubblesort$Increment]);
				case 'EQ':
					return _List_fromArray(
						[$author$project$Bubblesort$Increment, $author$project$Bubblesort$SwapAndIncrement]);
				default:
					return _List_fromArray(
						[$author$project$Bubblesort$SwapAndIncrement]);
			}
		} else {
			return _List_fromArray(
				[$author$project$Bubblesort$DecrementBAndResetI]);
		}
	}
};
				...
				switch (wrapperMessage.$) {
					...
					case 'ConfirmSubmit':
						...
						var score = A2(
							$elm$core$Debug$log,
							'Score',
							$author$project$DrivingTest$Scored(((n - d) / n) * 100));
						var newExp = _Utils_update(
							present,
							{score: score});
						return _Utils_Tuple2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Driving Test Score')
													])),
												A2(
												$elm$html$Html$button,
												_List_fromArray(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Score : ' + $elm$core$String$fromFloat(s))
											]))
									]))
							]))
					]));
...
var $goyalarchit$elm_dagre$Render$StandardDrawers$edgeLabelDrawer = F4(
	function (lbl, orientLabelAlongEdge, edgePathId, curve) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, midX, midY)
							]))
					]),
				_List_fromArray(
					[
...
var $goyalarchit$elm_dagre$Render$StandardDrawers$defNodeDrawerConfig = function () {
	...
	return {
		...
		label: f,
		onClick: $elm$core$Maybe$Nothing,
		shape: $goyalarchit$elm_dagre$Render$StandardDrawers$Types$Ellipse,
		strokeColor: function (_v1) {
			return $avh4$elm_color$Color$blue;
		},
		strokeDashArray: f_,
		strokeWidth: function (_v2) {
			return 1;
		},
		style: f_,
		title: f,
...
var $goyalarchit$elm_dagre$Render$StandardDrawers$xLabelDrawer = F3(
	function (xlbl, xLabelPos, nodeAtrib) {
		var _v0 = A3(xLabelPos, nodeAtrib.node, nodeAtrib.width, nodeAtrib.height);
		var xPosX = _v0.a;
		var xPosY = _v0.b;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm_community$typed_svg$TypedSvg$Types$Translate, xlPosX, xlPosY)
						]))
				]),
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($goyalarchit$elm_dagre$Render$StandardDrawers$nodeShapeDrawer, config, nodeAtrib),
					A2(
					$elm_community$typed_svg$TypedSvg$text_,
					_List_fromArray(
						[
					...
					A3($goyalarchit$elm_dagre$Render$StandardDrawers$xLabelDrawer, config.xLabel, config.xLabelPos, nodeAtrib)
				]));
	});
...
var $goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$xLabel = function (f) {
	return function (ndc) {
		return _Utils_update(
			ndc,
			{xLabel: f});
...
var $author$project$Bubblesort$xlbl = F2(
	function (model, n) {
...
var $author$project$Bubblesort$view = function (state) {
	var _v0 = state.ts;
	var i = _v0.i;
	var b = _v0.b;
	var numbers = _v0.numbers;
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$goyalarchit$elm_dagre$Render$style('height: 100%; width: 100%'),
						...
						$goyalarchit$elm_dagre$Render$StandardDrawers$svgDrawNode(
							_List_fromArray(
								[
									...
									$goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$xLabel(
									A2(
										$elm$core$Basics$composeR,
										$author$project$Bubblesort$xlbl(state.ts),
				...
				$author$project$ListView$createGraph(numbers))
			]));
};
var $author$project$Bubblesort$main = $author$project$DrivingTest$sandbox(
	{analyticsPort: $author$project$Bubblesort$analytics, btns: $author$project$Bubblesort$btns, init: $author$project$Bubblesort$init, isEnabled: $author$project$Bubblesort$isEnabled, msgType: $author$project$Bubblesort$msgType, next: $author$project$Bubblesort$next, update: $author$project$Bubblesort$update, view: $author$project$Bubblesort$view});
_Platform_export({'Bubblesort':{'init':$author$project$Bubblesort$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"DrivingTest.Msg Bubblesort.Msg","aliases":{},"unions":{"Bubblesort.Msg":{"args":[],"tags":{"Increment":[],"SwapAndIncrement":[],"DecrementBAndResetI":[],"GotRandom":["List.List Basics.Int"]}},"DrivingTest.Msg":{"args":["a"],"tags":{"Reset":[],"Redo":[],"Undo":[],"Forget":[],"Submit":[],"ConfirmSubmit":[],"CancelSubmit":[],"New":["a"],"Init":["a"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});}(this));