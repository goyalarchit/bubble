...
var $author$project$BubbleSortTest$main = $author$project$DrivingTest$sandbox(
	{analyticsPort: $author$project$BubbleSortTest$analytics, btns: $author$project$BubbleSortTest$btns, init: $author$project$BubbleSortTest$init, isEnabled: $author$project$BubbleSortTest$isEnabled, msgType: $author$project$BubbleSortTest$msgType, next: $author$project$BubbleSortTest$next, update: $author$project$BubbleSortTest$update, view: $author$project$BubbleSortTest$view});
