...
var $author$project$BubbleSortTest$analytics = _Platform_outgoingPort('analytics', $elm$core$Basics$identity);
...
var $author$project$BubbleSortTest$DecrementBAndResetI = {$: 'DecrementBAndResetI'};
var $author$project$BubbleSortTest$Increment = {$: 'Increment'};
var $author$project$BubbleSortTest$SwapAndIncrement = {$: 'SwapAndIncrement'};
var $author$project$BubbleSortTest$actionToName = function (msg) {
	switch (msg.$) {
		case 'Increment':
			return 'Increment i';
		case 'SwapAndIncrement':
			return 'Swap And Increment i';
		case 'DecrementBAndResetI':
			return 'Decrement b And Reset i';
		default:
			return 'Internal';
	}
};
...
var $author$project$BubbleSortTest$btns = _List_fromArray(
	[
		A2(
		$author$project$DrivingTest$primaryButton,
		$author$project$BubbleSortTest$actionToName($author$project$BubbleSortTest$Increment),
		$author$project$BubbleSortTest$Increment),
		A2(
		$author$project$DrivingTest$primaryButton,
		$author$project$BubbleSortTest$actionToName($author$project$BubbleSortTest$SwapAndIncrement),
		$author$project$BubbleSortTest$SwapAndIncrement),
		A2(
		$author$project$DrivingTest$primaryButton,
		$author$project$BubbleSortTest$actionToName($author$project$BubbleSortTest$DecrementBAndResetI),
		$author$project$BubbleSortTest$DecrementBAndResetI)
	]);
...
var $author$project$BubbleSortTest$allMsgs = A2(
	$elm$core$List$map,
	$author$project$BubbleSortTest$actionToName,
	_List_fromArray(
		[$author$project$BubbleSortTest$Increment, $author$project$BubbleSortTest$SwapAndIncrement, $author$project$BubbleSortTest$DecrementBAndResetI]));
var $elm$core$List$sortBy = _List_sortBy;
var $elm$core$List$sort = function (xs) {
	return A2($elm$core$List$sortBy, $elm$core$Basics$identity, xs);
};
var $author$project$BubbleSortTest$gradeRubric = A3(
	$author$project$DrivingTest$GradeRubric,
	function (n) {
		return _Utils_eq(
			$elm$core$List$sort(n.ts.numbers),
			n.ts.numbers);
	},
	$author$project$BubbleSortTest$allMsgs,
	$author$project$BubbleSortTest$actionToName);
var $author$project$BubbleSortTest$GotRandom = function (a) {
	return {$: 'GotRandom', a: a};
};
var $author$project$BubbleSortTest$Model = F3(
	function (numbers, i, b) {
		return {b: b, i: i, numbers: numbers};
	});
...
var $author$project$BubbleSortTest$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			...
			_Utils_Tuple0,
			A3(
				$author$project$BubbleSortTest$Model,
				_List_fromArray(
					[5, 4, 3, 2, 1]),
				0,
				5)),
		A2(
			$elm$random$Random$generate,
			$author$project$BubbleSortTest$GotRandom,
			A2(
...
var $author$project$BubbleSortTest$isEnabled = F2(
	function (msg, state) {
		var okTxt = $author$project$Utils$okMessage(
			$author$project$BubbleSortTest$actionToName(msg));
		var n = $elm$core$List$length(state.ts.numbers);
		var _v0 = state.ts;
		var i = _v0.i;
		var b = _v0.b;
		...
		switch (msg.$) {
			case 'Increment':
				return (_Utils_cmp(i, n - 1) < 0) ? $elm$core$Result$Ok(okTxt) : $elm$core$Result$Err(
					$author$project$Utils$errMessage('i will go out of bounds'));
			case 'SwapAndIncrement':
				return (_Utils_cmp(i, n - 1) < 0) ? $elm$core$Result$Ok(okTxt) : $elm$core$Result$Err(
					$author$project$Utils$errMessage('i will go out of bounds'));
			case 'DecrementBAndResetI':
				return (b > 0) ? $elm$core$Result$Ok(okTxt) : $elm$core$Result$Err(
					$author$project$Utils$errMessage('Error! b will go out of bounds'));
			default:
...
var $author$project$BubbleSortTest$msgType = function (msg) {
	if (msg.$ === 'GotRandom') {
...
var $author$project$BubbleSortTest$ordered = F3(
	function (i, j, nums) {
		...
		if ((_v1.a.$ === 'Just') && (_v1.b.$ === 'Just')) {
			var a_i = _v1.a.a;
			var a_j = _v1.b.a;
			return (_Utils_cmp(a_i, a_j) < 0) ? $elm$core$Basics$LT : (_Utils_eq(a_i, a_j) ? $elm$core$Basics$EQ : $elm$core$Basics$GT);
		} else {
			return $elm$core$Basics$GT;
		}
	});
var $author$project$BubbleSortTest$next = function (state) {
	var _v0 = state.ts;
	var i = _v0.i;
	var b = _v0.b;
	var numbers = _v0.numbers;
	if ((!i) && (b === 1)) {
		...
		if (_Utils_cmp(i, b - 1) < 0) {
			var _v1 = A3($author$project$BubbleSortTest$ordered, i, i + 1, numbers);
			switch (_v1.$) {
				case 'LT':
					return _List_fromArray(
						[$author$project$BubbleSortTest$Increment]);
				case 'EQ':
					return _List_fromArray(
						[$author$project$BubbleSortTest$Increment, $author$project$BubbleSortTest$SwapAndIncrement]);
				default:
					return _List_fromArray(
						[$author$project$BubbleSortTest$SwapAndIncrement]);
			}
...
var $author$project$BubbleSortTest$update = F2(
	function (msg, state) {
		...
		switch (msg.$) {
			...
			case 'SwapAndIncrement':
				if (_Utils_cmp(ts.i, n - 1) < 0) {
					var nums = A3($elm_community$list_extra$List$Extra$swapAt, ts.i, ts.i + 1, ts.numbers);
					var newTS = _Utils_update(
						ts,
						{i: ts.i + 1, numbers: nums});
					return _Utils_update(
						state,
						{ts: newTS});
				} else {
...
var $author$project$BubbleSortTest$changeLabel = function (node) {
	return _Utils_eq(node.label, -1) ? '' : $elm$core$String$fromInt(node.label);
};
...
var $author$project$BubbleSortTest$changeShape = F2(
	function (idx, node) {
		return _Utils_eq(node.label, -1) ? _Utils_Tuple3($goyalarchit$elm_dagre$Render$StandardDrawers$Types$NoShape, 1, '') : ((_Utils_eq(node.id, idx) || _Utils_eq(node.id, idx + 1)) ? _Utils_Tuple3($goyalarchit$elm_dagre$Render$StandardDrawers$Types$Ellipse, 2, '4') : _Utils_Tuple3($goyalarchit$elm_dagre$Render$StandardDrawers$Types$Ellipse, 1, ''));
	});
var $goyalarchit$elm_dagre$Render$StandardDrawers$Types$Circle = {$: 'Circle'};
var $author$project$BubbleSortTest$changeShapeXlabel = F2(
	function (idx, node) {
		return (_Utils_eq(node.id, idx) || _Utils_eq(node.id, idx + 1)) ? _Utils_Tuple3($goyalarchit$elm_dagre$Render$StandardDrawers$Types$Circle, 1, '4') : _Utils_Tuple3($goyalarchit$elm_dagre$Render$StandardDrawers$Types$NoShape, 1, '');
	});
...
var $author$project$BubbleSortTest$varLabel = F2(
	function (_v0, node) {
		var i = _v0.a;
		var b = _v0.b;
		var _v1 = _Utils_Tuple2(
...
var $author$project$BubbleSortTest$viewList = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				...
				$goyalarchit$elm_dagre$Render$StandardDrawers$svgDrawNode(
					_List_fromArray(
						[
							$goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$label($author$project$BubbleSortTest$changeLabel),
							$goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$shape(
							A2(
								$elm$core$Basics$composeR,
								$author$project$BubbleSortTest$changeShape(model.i),
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(
												$elm$core$Basics$composeR,
												$author$project$BubbleSortTest$changeShapeXlabel(model.i),
												$TSFoster$elm_tuple_extra$Tuple3$first)),
											$goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$strokeWidth(
											A2(
												$elm$core$Basics$composeR,
									...
									_List_fromArray(
										[
											$goyalarchit$elm_dagre$Render$StandardDrawers$Attributes$label(
											$author$project$BubbleSortTest$varLabel(
		...
		$author$project$ListView$createGraph(
			A2(
				$elm$core$List$append,
				model.numbers,
				_List_fromArray(
...
var $author$project$BubbleSortTest$view = function (state) {
	var _v0 = state.ts;
	var i = _v0.i;
	var b = _v0.b;
	var numbers = _v0.numbers;
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('boundary (b)', b)
					])),
				$author$project$BubbleSortTest$viewList(state.ts)
			]));
};
var $author$project$BubbleSortTest$main = $author$project$DrivingTest$sandbox(
	{analyticsPort: $author$project$BubbleSortTest$analytics, btns: $author$project$BubbleSortTest$btns, gradeRubric: $author$project$BubbleSortTest$gradeRubric, init: $author$project$BubbleSortTest$init, isEnabled: $author$project$BubbleSortTest$isEnabled, msgType: $author$project$BubbleSortTest$msgType, next: $author$project$BubbleSortTest$next, update: $author$project$BubbleSortTest$update, view: $author$project$BubbleSortTest$view});
